...
class Build {
  ...
  static String get appName => "ErrorX";

  static String get coreName => "ErrorXCore";
  ...
  static buildHelper(Target target) async {
    ...
    final outPath = join(
      ...
      "target",
      "release",
      "ErrorXHelperService${target.executableExtensionName}",
    );
  ...
  Future<void> run() async {
    ...
    switch (target) {
      ...
      case Target.linux:
        ...
        final targets = [
          "deb",
          if (arch == Arch.amd64) ...["appimage", "rpm"],
        ].join(",");
